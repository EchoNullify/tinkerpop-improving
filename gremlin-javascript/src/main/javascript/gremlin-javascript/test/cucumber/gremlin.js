...
const gremlins = {
    ...
    g_V_none: [function({g}) { return g.V().none() }],
    g_V_none_none: [function({g}) { return g.V().none().none() }],
    g_V_none_fold: [function({g}) { return g.V().none().fold() }],
    g_V_none_fold_none: [function({g}) { return g.V().none().fold().none() }],
    g_V_none_fold_constantX1X: [function({g}) { return g.V().none().fold().constant(1) }],
    g_V_projectXxX_byXcoalesceXage_isXgtX29XX_noneXX_selectXxX: [function({g}) { return g.V().project("x").by(__.coalesce(__.values("age").is(P.gt(29)), __.none())).select("x") }],
    ...
    g_withStrategiesXEarlyLimitStrategyX_V_out_order_valueMap_limitX3X_selectXnameX: [function({g}) { return g.withStrategies(new EarlyLimitStrategy()).V().out().order().valueMap().limit(3).select("name") }], 
    g_withoutStrategiesXEarlyLimitStrategyX_V_out_order_valueMap_limitX3X_selectXnameX: [function({g}) { return g.withoutStrategies(EarlyLimitStrategy).V().out().order().valueMap().limit(3).select("name") }], 
    ...
    g_V_classic_recommendation: [function({g}) { return g.V().has("name", "DARK STAR").as("a").out("followedBy").aggregate("stash").in_("followedBy").where(P.neq("a").and(P.not(P.within("stash")))).groupCount().unfold().project("x", "y", "z").by(__.select(Column.keys).values("name")).by(__.select(Column.keys).values("performances")).by(__.select(Column.values)).order().by(__.select("z"), Order.desc).by(__.select("y"), Order.asc).limit(5).aggregate(Scope.local, "m").select("x") }], 
    g_V_classic_recommendation_ranked: [function({g}) { return g.V().has("name", "DARK STAR").as("a").out("followedBy").aggregate("stash").in_("followedBy").where(P.neq("a").and(P.not(P.within("stash")))).groupCount().unfold().project("x", "y", "z").by(__.select(Column.keys).values("name")).by(__.select(Column.keys).values("performances")).by(__.select(Column.values)).order().by(__.select("z"), Order.desc).by(__.select("y"), Order.asc).limit(5).aggregate(Scope.local, "m") }], 
    ...
    g_injectXdatetimeXstrXX_dateAddXDT_hour_2X: [function({g}) { return g.inject(new Date('2023-08-02T00:00Z')).dateAdd(DT.hour, 2) }],
    g_injectXdatetimeXstrXX_dateAddXhour_2X: [function({g}) { return g.inject(new Date('2023-08-02T00:00Z')).dateAdd(DT.hour, 2) }],
    g_injectXdatetimeXstrXX_dateAddXhour_1X: [function({g}) { return g.inject(new Date('2023-08-02T00:00Z')).dateAdd(DT.hour, -1) }],
    g_injectXdatetimeXstrXX_dateAddXminute_10X: [function({g}) { return g.inject(new Date('2023-08-02T00:00Z')).dateAdd(DT.minute, 10) }],
    g_injectXdatetimeXstrXX_dateAddXsecond_20X: [function({g}) { return g.inject(new Date('2023-08-02T00:00Z')).dateAdd(DT.second, 20) }],
    g_injectXdatetimeXstrXX_dateAddXday_11X: [function({g}) { return g.inject(new Date('2023-09-06T00:00Z')).dateAdd(DT.day, 11) }],
    g_injectXDateTimeXstrXX_dateAddXDT_hour_2X: [function({g}) { return g.inject(new Date('2023-08-02T00:00Z')).dateAdd(DT.hour, 2) }],
    g_injectXDateTimeXstrXX_dateAddXhour_2X: [function({g}) { return g.inject(new Date('2023-08-02T00:00Z')).dateAdd(DT.hour, 2) }],
    g_injectXDateTimeXstrXX_dateAddXhour_1X: [function({g}) { return g.inject(new Date('2023-08-02T00:00Z')).dateAdd(DT.hour, -1) }],
    g_injectXDateTimeXstrXX_dateAddXminute_10X: [function({g}) { return g.inject(new Date('2023-08-02T00:00Z')).dateAdd(DT.minute, 10) }],
    g_injectXDateTimeXstrXX_dateAddXsecond_20X: [function({g}) { return g.inject(new Date('2023-08-02T00:00Z')).dateAdd(DT.second, 20) }],
    g_injectXDateTimeXstrXX_dateAddXday_11X: [function({g}) { return g.inject(new Date('2023-09-06T00:00Z')).dateAdd(DT.day, 11) }],
    g_injectXdatetimeXstr1XX_dateDiffXdatetimeXstr2XX: [function({g}) { return g.inject(new Date('2023-08-02T00:00Z')).dateDiff(new Date('2023-08-09T00:00Z')) }],
    g_injectXdatetimeXstr1XX_dateDiffXconstantXdatetimeXstr2XXX: [function({g}) { return g.inject(new Date('2023-08-08T00:00Z')).dateDiff(__.constant(new Date('2023-08-01T00:00Z'))) }],
    g_injectXdatetimeXstr1XX_dateDiffXinjectXdatetimeXstr2XXX: [function({g}) { return g.inject(new Date('2023-08-08T00:00Z')).dateDiff(__.inject(new Date('2023-10-11T00:00Z'))) }],
    g_injectXDateTimeXstr1XX_dateDiffXDateTimeXstr2XX: [function({g}) { return g.inject(new Date('2023-08-02T00:00Z')).dateDiff(new Date('2023-08-09T00:00Z')) }],
    g_injectXDateTimeXstr1XX_dateDiffXconstantXDateTimeXstr2XXX: [function({g}) { return g.inject(new Date('2023-08-08T00:00Z')).dateDiff(__.constant(new Date('2023-08-01T00:00Z'))) }],
    g_injectXDateTimeXstr1XX_dateDiffXinjectXDateTimeXstr2XXX: [function({g}) { return g.inject(new Date('2023-08-08T00:00Z')).dateDiff(__.inject(new Date('2023-10-11T00:00Z'))) }],
    ...
    g_mergeVXlabel_person_name_marko_age_29X_optionXonMatch_age_nullX_allowed: [function({g, xx1, xx2}) { return g.addV("person").property("name", "marko").property("age", 29) }, function({g, xx1, xx2}) { return g.mergeV(xx1).option(Merge.onMatch, xx2) }, function({g, xx1, xx2}) { return g.V() }, function({g, xx1, xx2}) { return g.V().has("person", "name", "marko").has("age", null) }], 
    g_mergeVXlabel_person_name_marko_age_29X_optionXonMatch_age_nullX: [function({g, xx1, xx2}) { return g.addV("person").property("name", "marko").property("age", 29) }, function({g, xx1, xx2}) { return g.mergeV(xx1).option(Merge.onMatch, xx2) }, function({g, xx1, xx2}) { return g.V() }, function({g, xx1, xx2}) { return g.V().has("person", "name", "marko").has("age") }], 
    ...
    g_V_sum_overflow_int: [function({g}) { return g.inject(2147483647, 1).sum() }],
    ...
    g_withStrategiesXProductiveByStrategyX_V_aggregateXlocal_xX_byXageX_capXxX: [function({g}) { return g.withStrategies(new ProductiveByStrategy()).V().aggregate(Scope.local, "x").by("age").cap("x") }], 
    ...
    g_withSideEffectXa_1_sumX_V_aggregateXlocal_aX_byXageX_capXaX: [function({g}) { return g.withSideEffect("a", 1, Operator.sum).V().aggregate(Scope.local, "a").by("age").cap("a") }], 
    ...
    g_withSideEffectXa_123_minusX_V_aggregateXlocal_aX_byXageX_capXaX: [function({g}) { return g.withSideEffect("a", 123, Operator.minus).V().aggregate(Scope.local, "a").by("age").cap("a") }], 
    ...
    g_withSideEffectXa_2_multX_V_aggregateXlocal_aX_byXageX_capXaX: [function({g}) { return g.withSideEffect("a", 2, Operator.mult).V().aggregate(Scope.local, "a").by("age").cap("a") }], 
    ...
    g_withSideEffectXa_876960_divX_V_aggregateXlocal_aX_byXageX_capXaX: [function({g}) { return g.withSideEffect("a", 876960, Operator.div).V().aggregate(Scope.local, "a").by("age").cap("a") }], 
    ...
    g_withSideEffectXa_1_minX_V_aggregateXlocal_aX_byXageX_capXaX: [function({g}) { return g.withSideEffect("a", 1, Operator.min).V().aggregate(Scope.local, "a").by("age").cap("a") }], 
    ...
    g_withSideEffectXa_100_minX_V_aggregateXlocal_aX_byXageX_capXaX: [function({g}) { return g.withSideEffect("a", 100, Operator.min).V().aggregate(Scope.local, "a").by("age").cap("a") }], 
    ...
    g_withSideEffectXa_1_maxX_V_aggregateXlocal_aX_byXageX_capXaX: [function({g}) { return g.withSideEffect("a", 1, Operator.max).V().aggregate(Scope.local, "a").by("age").cap("a") }], 
    ...
    g_withSideEffectXa_100_maxX_V_aggregateXlocal_aX_byXageX_capXaX: [function({g}) { return g.withSideEffect("a", 100, Operator.max).V().aggregate(Scope.local, "a").by("age").cap("a") }], 
    ...
    g_withSideEffectXa_true_andX_V_constantXfalseX_aggregateXlocal_aX_capXaX: [function({g}) { return g.withSideEffect("a", true, Operator.and).V().constant(false).aggregate(Scope.local, "a").cap("a") }], 
    ...
    g_withSideEffectXa_true_orX_V_constantXfalseX_aggregateXlocal_aX_capXaX: [function({g}) { return g.withSideEffect("a", true, Operator.or).V().constant(false).aggregate(Scope.local, "a").cap("a") }], 
    g_withSideEffectXa_xx1_addAllX_V_aggregateXaX_byXageX_capXaX: [function({g, xx1}) { return g.withSideEffect("a", xx1, Operator.addAll).V().aggregate("a").by("age").cap("a") }], 
