...
world.gremlins = {
    ...
    'g_V_projectXxX_byXcoalesceXage_isXgtX29XX_noneXX_selectXxX': [(lambda g:g.V().project('x').by(__.coalesce(__.values('age').is_(P.gt(29)), __.none())).select('x'))],
    ...
    'g_injectXdatetimeXstrXX_dateAddXDT_hour_2X': [(lambda g:g.inject(datetime.datetime.fromisoformat('2023-08-02T00:00+00:00')).date_add(DT.hour, 2))],
    'g_injectXdatetimeXstrXX_dateAddXhour_2X': [(lambda g:g.inject(datetime.datetime.fromisoformat('2023-08-02T00:00+00:00')).date_add(DT.hour, 2))],
    'g_injectXdatetimeXstrXX_dateAddXhour_1X': [(lambda g:g.inject(datetime.datetime.fromisoformat('2023-08-02T00:00+00:00')).date_add(DT.hour, -1))],
    'g_injectXdatetimeXstrXX_dateAddXminute_10X': [(lambda g:g.inject(datetime.datetime.fromisoformat('2023-08-02T00:00+00:00')).date_add(DT.minute, 10))],
    'g_injectXdatetimeXstrXX_dateAddXsecond_20X': [(lambda g:g.inject(datetime.datetime.fromisoformat('2023-08-02T00:00+00:00')).date_add(DT.second, 20))],
    'g_injectXdatetimeXstrXX_dateAddXday_11X': [(lambda g:g.inject(datetime.datetime.fromisoformat('2023-09-06T00:00+00:00')).date_add(DT.day, 11))],
    'g_injectXDateTimeXstrXX_dateAddXDT_hour_2X': [(lambda g:g.inject(datetime.datetime.fromisoformat('2023-08-02T00:00+00:00')).date_add(DT.hour, 2))],
    'g_injectXDateTimeXstrXX_dateAddXhour_2X': [(lambda g:g.inject(datetime.datetime.fromisoformat('2023-08-02T00:00+00:00')).date_add(DT.hour, 2))],
    'g_injectXDateTimeXstrXX_dateAddXhour_1X': [(lambda g:g.inject(datetime.datetime.fromisoformat('2023-08-02T00:00+00:00')).date_add(DT.hour, -1))],
    'g_injectXDateTimeXstrXX_dateAddXminute_10X': [(lambda g:g.inject(datetime.datetime.fromisoformat('2023-08-02T00:00+00:00')).date_add(DT.minute, 10))],
    'g_injectXDateTimeXstrXX_dateAddXsecond_20X': [(lambda g:g.inject(datetime.datetime.fromisoformat('2023-08-02T00:00+00:00')).date_add(DT.second, 20))],
    'g_injectXDateTimeXstrXX_dateAddXday_11X': [(lambda g:g.inject(datetime.datetime.fromisoformat('2023-09-06T00:00+00:00')).date_add(DT.day, 11))],
    'g_injectXdatetimeXstr1XX_dateDiffXdatetimeXstr2XX': [(lambda g:g.inject(datetime.datetime.fromisoformat('2023-08-02T00:00+00:00')).date_diff(datetime.datetime.fromisoformat('2023-08-09T00:00+00:00')))],
    'g_injectXdatetimeXstr1XX_dateDiffXconstantXdatetimeXstr2XXX': [(lambda g:g.inject(datetime.datetime.fromisoformat('2023-08-08T00:00+00:00')).date_diff(__.constant(datetime.datetime.fromisoformat('2023-08-01T00:00+00:00'))))],
    'g_injectXdatetimeXstr1XX_dateDiffXinjectXdatetimeXstr2XXX': [(lambda g:g.inject(datetime.datetime.fromisoformat('2023-08-08T00:00+00:00')).date_diff(__.inject(datetime.datetime.fromisoformat('2023-10-11T00:00+00:00'))))],
    'g_injectXDateTimeXstr1XX_dateDiffXDateTimeXstr2XX': [(lambda g:g.inject(datetime.datetime.fromisoformat('2023-08-02T00:00+00:00')).date_diff(datetime.datetime.fromisoformat('2023-08-09T00:00+00:00')))],
    'g_injectXDateTimeXstr1XX_dateDiffXconstantXDateTimeXstr2XXX': [(lambda g:g.inject(datetime.datetime.fromisoformat('2023-08-08T00:00+00:00')).date_diff(__.constant(datetime.datetime.fromisoformat('2023-08-01T00:00+00:00'))))],
    'g_injectXDateTimeXstr1XX_dateDiffXinjectXDateTimeXstr2XXX': [(lambda g:g.inject(datetime.datetime.fromisoformat('2023-08-08T00:00+00:00')).date_diff(__.inject(datetime.datetime.fromisoformat('2023-10-11T00:00+00:00'))))],
    ...
    'g_injectXlist1_list2X_mergeEXlimitXlocal_1XX_optionXonCreate_rangeXlocal_1_2XX_optionXonMatch_tailXlocalXX_to_match': [(lambda g, xx1=None,xx2=None:g.add_v('person').property('name', 'marko').property('age', 29).as_('marko').add_v('person').property('name', 'vadas').property('age', 27).as_('vadas').add_v('software').property('name', 'lop').property('lang', 'java').as_('lop').add_v('person').property('name', 'josh').property('age', 32).as_('josh').add_v('software').property('name', 'ripple').property('lang', 'java').as_('ripple').add_v('person').property('name', 'peter').property('age', 35).as_('peter').add_e('knows').from_('marko').to('vadas').property('weight', 0.5).add_e('knows').from_('marko').to('josh').property('weight', 1.0).add_e('created').from_('marko').to('lop').property('weight', 0.4).add_e('created').from_('josh').to('ripple').property('weight', 1.0).add_e('created').from_('josh').to('lop').property('weight', 0.4).add_e('created').from_('peter').to('lop').property('weight', 0.2)), (lambda g, xx1=None,xx2=None:g.inject(xx1, xx1, xx2).fold().merge_e(__.limit(Scope.local, 1)).option(Merge.on_create, __.range_(Scope.local, 1, 2)).option(Merge.on_match, __.tail(Scope.local))), (lambda g, xx1=None,xx2=None:g.V()), (lambda g, xx1=None,xx2=None:g.E()), (lambda g, xx1=None,xx2=None:g.E().has('created', 'N')), (lambda g, xx1=None,xx2=None:g.V().has('person', 'name', 'marko').out_e('knows').has('created', 'N').in_v().has('person', 'name', 'vadas'))],
    'g_injectXlist1_list2X_mergeEXlimitXlocal_1XX_optionXonCreate_rangeXlocal_1_2XX_optionXonMatch_tailXlocalXX_to_create': [(lambda g, xx1=None,xx2=None:g.add_v('person').property('name', 'marko').property('age', 29).as_('marko').add_v('person').property('name', 'vadas').property('age', 27).as_('vadas').add_v('software').property('name', 'lop').property('lang', 'java').as_('lop').add_v('person').property('name', 'josh').property('age', 32).as_('josh').add_v('software').property('name', 'ripple').property('lang', 'java').as_('ripple').add_v('person').property('name', 'peter').property('age', 35).as_('peter').add_e('knows').from_('marko').to('vadas').property('weight', 0.5).add_e('knows').from_('marko').to('josh').property('weight', 1.0).add_e('created').from_('marko').to('lop').property('weight', 0.4).add_e('created').from_('josh').to('ripple').property('weight', 1.0).add_e('created').from_('josh').to('lop').property('weight', 0.4).add_e('created').from_('peter').to('lop').property('weight', 0.2)), (lambda g, xx1=None,xx2=None:g.inject(xx1, xx1, xx2).fold().merge_e(__.limit(Scope.local, 1)).option(Merge.on_create, __.range_(Scope.local, 1, 2)).option(Merge.on_match, __.tail(Scope.local))), (lambda g, xx1=None,xx2=None:g.V()), (lambda g, xx1=None,xx2=None:g.E()), (lambda g, xx1=None,xx2=None:g.E().has_not('created')), (lambda g, xx1=None,xx2=None:g.V().has('person', 'name', 'marko').out_e('knows').has_not('created').in_v().has('person', 'name', 'vadas')), (lambda g, xx1=None,xx2=None:g.V().has('person', 'name', 'vadas').out_e('self').has_not('weight').in_v().has('person', 'name', 'vadas'))],
    'g_mergeEXlabel_knows_out_marko_in_vadasX_optionXonMatch_weight_nullX_allowed': [(lambda g, xx1=None,xx2=None:g.add_v('person').property('name', 'marko').as_('a').add_v('person').property('name', 'vadas').as_('b').add_e('knows').from_('a').to('b').property('weight', 1.0)), (lambda g, xx1=None,xx2=None:g.merge_e(xx1).option(Merge.on_match, xx2)), (lambda g, xx1=None,xx2=None:g.V()), (lambda g, xx1=None,xx2=None:g.E().has_label('knows')), (lambda g, xx1=None,xx2=None:g.E().has_label('knows').has('weight', None))], 
    'g_mergeEXlabel_knows_out_marko_in_vadasX_optionXonMatch_weight_nullX': [(lambda g, xx1=None,xx2=None:g.add_v('person').property('name', 'marko').as_('a').add_v('person').property('name', 'vadas').as_('b').add_e('knows').from_('a').to('b').property('weight', 1.0)), (lambda g, xx1=None,xx2=None:g.merge_e(xx1).option(Merge.on_match, xx2)), (lambda g, xx1=None,xx2=None:g.V()), (lambda g, xx1=None,xx2=None:g.E().has_label('knows')), (lambda g, xx1=None,xx2=None:g.E().has_label('knows').has('weight'))], 
